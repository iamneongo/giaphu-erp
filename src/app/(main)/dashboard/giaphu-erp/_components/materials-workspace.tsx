        ...
        <SectionBlock title="Định mức vật tư">
            <DataTable
              ...
              columns={[
                ...
                { key: "materialType", label: "Loại", accessor: (row) => row.materialType, render: (row) => row.materialType },
                {
                  key: "dailyNorm",
                  label: "ĐM ngày",
              ...
              filters={[
                { key: "category", label: "Hạng mục", options: uniqueOptions(scoped.materialNorms.map((row) => row.category)) },
                { key: "materialType", label: "Loại", options: materialTypeOptions },
              ]}
            />
        </SectionBlock>
