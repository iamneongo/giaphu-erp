      ...
      <div className="space-y-4">
        <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card grid grid-cols-1 gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:grid-cols-2 2xl:grid-cols-4">
          ...
          <MetricCard
            ...
            trend={
              insights.headline.contractValue
                ? (insights.headline.totalCost / insights.headline.contractValue) * 100
                : 0
            }
          ...
          <MetricCard
            ...
            trend={
              insights.headline.totalCost ? (insights.headline.openMaterialDebt / insights.headline.totalCost) * 100 : 0
            }
            icon={PackageSearch}
          ...
          <Card className="lg:col-span-4">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                <Badge variant="outline">
                  <Activity className="mr-1 size-3.5" />4 nhóm chi
                </Badge>
              </CardTitle>
